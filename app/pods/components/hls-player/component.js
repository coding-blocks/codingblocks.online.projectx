...
export default Component.extend(KeyboardShortcuts, {
  ...
  didReceiveAttrs() {
    ...
    if (this.copySrc === this.src) return;
  ...
  didInsertElement() {
    ...
    video.oncanplaythrough = () => {
      ...
      if (this.isSafari) this.seekTo.call(this, 1);
    };

    if (this.isSafari) video.onplay = () => this.seekTo.call(this, 1);
