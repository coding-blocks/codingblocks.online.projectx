...
export default class SpinIndexController extends Controller {
  ...
  get shareText() {
    return `Hey, have you found out about Coding Blocks' Valentine’s Campaign? This week of love, Coding Blocks is all set to spread love and learning. Click on https://cb.lk/join/${this.referralCode} to win an additional heart. https://cb.lk/vdoncb`
  }
