...
export default class CricketMatchCardComponent extends Component {
  ...
  @restartableTask fetchScore = function *() {
    while (true) {
      ...
      this.set('team1score', score.batting.id === this.match.team1.id ? score.batting.score : score.bowling.score)
      this.set('team2score', score.batting.id === this.match.team2.id ? score.batting.score : score.bowling.score)
